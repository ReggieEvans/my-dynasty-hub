...
export const enrollmentSizeMap = {
  small: { min: 0, max: 19000 },
  medium: { min: 19001, max: 27000 },
  large: { min: 27001, max: 37000 },
  'very large': { min: 37001, max: Infinity },
}
...
// Defensive Schemes
export const defensiveSchemeOptions = ['3-3-5', '3-4', '4-2-5', '4-3', '4-4', 'Multiple']
...
export const filterConfig: FilterOption[] = [
  {
    ...
    category: FilterCategory.BasicFilters,
  },
  ...
  {
    key: 'dynastyOffenseOVR',
    label: 'Offense Overall',
    type: 'number',
    category: FilterCategory.BasicFilters,
    inputType: 'select',
    options: ratingOptions,
  ...
  {
    key: 'dynastyDefenseOVR',
    label: 'Defense Overall',
    type: 'number',
    category: FilterCategory.BasicFilters,
    inputType: 'select',
    options: ratingOptions,
  ...
  {
    key: 'championshipContender',
    label: 'Championship Contender',
    type: 'number',
    category: FilterCategory.SchoolFilters,
    inputType: 'select',
    options: Object.keys(gradeToValueMap),
    useGradeMap: true,
    operator: '=',
  },
  {
    key: 'conferencePrestige',
    label: 'Conference Prestige',
    type: 'number',
    category: FilterCategory.SchoolFilters,
    inputType: 'select',
    options: Object.keys(gradeToValueMap),
  ...
  {
    key: 'programTradition',
    label: 'Program Tradition',
    type: 'number',
    category: FilterCategory.SchoolFilters,
    inputType: 'select',
    options: Object.keys(gradeToValueMap),
  ...
  {
    key: 'stadiumAtmosphere',
    label: 'Stadium Atmosphere',
    type: 'number',
    category: FilterCategory.StadiumFilters,
    inputType: 'select',
    options: Object.keys(gradeToValueMap),
    useGradeMap: true,
    operator: '=',
  },
  {
    ...
    inputType: 'select',
    operator: '=',
    options: stadiumCapacityOptions,
  },
  {
    key: 'fieldType',
    label: 'Field Type',
  ...
  },
  {
    ...
    type: 'select',
    category: FilterCategory.PlaybookFilters,
